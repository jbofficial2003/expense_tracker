...
import { PlusCircle, Users, Receipt, PieChart, Trash2 } from 'lucide-react';
        ...
        <div>
          ...
          {expenses.length === 0 ? (
            ...
            <div className="flex-col gap-4">
              {expenses.map(exp => (
                <div key={exp._id} className="glass-card flex justify-between items-center" style={{ padding: '20px' }}>
